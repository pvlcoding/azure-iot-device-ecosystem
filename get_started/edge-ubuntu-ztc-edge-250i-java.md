...
# Introduction
**About this document**
This document describes how to connect ztC Edge 250i device running Ubuntu Server 18.04 with Azure IoT Edge Runtime pre-installed and Device Management. This multi-step process includes:
